# -*- coding: utf-8 -*-
"""
Created on Tue Sep  5 14:23:52 2023

@author: crystal
@inputFields -> email, first_name,last_name, company_name,maintenance_renewal_date, product_features checkboxes
"""
...
def main(event):
  ...
  maintenance_date = event["inputFields"]["maintenance_renewal_date"]
  product_features =  event["inputFields"]["product_features"]
  


  product_features_tmp = [ x.strip() for x in product_features.split(';') ]
