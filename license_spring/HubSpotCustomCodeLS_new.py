# -*- coding: utf-8 -*-
"""
Created on Thu Aug 31 17:59:49 2023
...
def main(event):
  ...
  product_features_addons =  event["inputFields"]["product_features_addons"]
  ...
  try:
    response = requests.get(
      ...
      url='{}{}'.format(API_URL, '/api/v1/orders/generate_license/?product=product_short_code&quantity=1'),
      headers={
  ...
  jsn={
      ...
      "items": [
      {
          ...
          "licenses": [
          {
             ...
             "product_features": my_prod_features_default,
              "is_trial": True,
  ...
  return {
      "outputFields": {
        ...
        "tech_support_exp": in15days.isoformat(),
        "activated": "Yes"
      }
   }